<?php
// $Id: template.php,v 1.1.2.20 2010/04/07 08:06:23 jmburnz Exp $
...
function genesis_preprocess_page(&$vars, $hook) {
  ...
  $vars['logo_alt']  = check_plain(variable_get('site_name', '')) .' '. t('logo');
  $vars['logo_img']  = $vars['logo'] ? '<img src="'. check_url($vars['logo']) .'" alt="'. $vars['logo_alt'] .'" title="'. t('Home page') .'"/>' : '';
